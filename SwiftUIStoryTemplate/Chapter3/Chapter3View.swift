            ...
            ZStack{
                VStack {
                    ...
                    */
                    ...
                    ScrollView{
                        VStack{
                            Text("\(mainCharacter), was mentally broken after having to deal with \(villianCharacter) and his actions. She needed to find comfort, so she decided to relax at starbucks and get a nice hot drink.")
                                .padding(10)
                            Text("\(mainCharacter) eyes traveled over the poster, it was a peer group on learning about self-respect! The peer group was held by a young man named \(supportCharacter).")
                            ...
                            Text(".....fast forward to next week!.......")
                                .padding(10)
                            Text("\(mainCharacter) stood at the outside of the building that divided her and her future. She hesitated before walking into the room that was labeled 'Women Support Group'. When she opened the door she was met with a group of women sitting in a circle. It seems like they were already in the middle of activity speaking one by one...")
                            ...
                            Text("My name Adriana, I am strong, and I am independent.")
                                .padding(10)
                            //wait a minute bro....
                            Text("When \(mainCharacter) entered the room all eyes locked onto her. \(mainCharacter) walked to her seat and sat down and followed along with the current activity. When it ended, the group started another activity which required everyone to get into groups of two.")
                            Image("stop")
                                .resizable()
                                .scaledToFit()
                            Text("\(mainCharacter) felt super nervous, I mean she didn't know a lot of people in the group. Her eyes wandered between Jessica, Brenda, and Adriana wondering who she thought would be the best choice.")
                                .padding(10)
                            Text("After choosing her partner, \(supportCharacter) then gave out sticky notes with different topics for icebreakers. Some topics were silly and fun while the others had much deeper and serious topics.")
                                .padding(10)
                            Text("The topic \(mainCharacter) and \(BrendaInfo.name) got a sticky note that said Who is you're biggest inspiration? \(BrendaInfo.name) responded:")
                                .padding(10)
                            Text("The icebreakers didn't last long but they realized some of these small conversations led to many meaningful and deep coversations. When the session came to an end she left with a new found confidence and a sense of hope about the future of her relationship. Especially after hearing storiees from other women. However, when she arrived home, she felt confliction, she wanted to be able to tell someone about her accomplishment.")
                                .padding(10)
                            Image("help")
                                .resizable()
                                .scaledToFit()
